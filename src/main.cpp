...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "6 MAY 2014 Silkcoin is finally finished";
        CTransaction txNew;
        ...
        block.nNonce   = 1663708;


        //// debug print
        ///
        assert(block.hashMerkleRoot == uint256("0xe5232ed85d488f6134428cab09fcfc2e66797ab6f7686ef686c5b98dfa1cca48"));
        block.print();
